...
router.post('/verify-resendotp',(req ,res) => controller.resentOtpVerification(req,res))
router.patch('/resetpass',(req ,res) => controller.resetPassword(req,res))
router.post('/login',(req,res ) => controller.login(req,res))
router.post('/logout',(req,res ) => controller.logout(req,res))
router.post('/make-payment',(req,res ) => controller.makePayment(req,res))
router.post('/webhook',(req,res ) => controller.paymentWebHook(req,res))
router.get('/bookings/:userId',(req,res ) => controller.getBookings(req,res))
